package com.android.ika.pratiwiikakartika_1202154314_modul5;
...
public class Settings extends AppCompatActivity {
    ...
    public String getShapeColor(int i) {
        if (i == R.color.coral) {
            return "Coral";
        } else if (i == R.color.lightcoral) {
            return "Light Coral";
        } else if (i == R.color.crismon) {
            return "Crismon";
        } else {
            return "Default";
        }
    ...
    public void pilihWarna(View view) {
        ...
        alert.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                switch (a) {
                    case R.id.coral:
                        colorid = R.color.coral;
                        break;
                    case R.id.light:
                        colorid = R.color.lightcoral;
                        break;
                    case R.id.crismon:
                        colorid = R.color.crismon;
                        break;
                    case R.id.white:
